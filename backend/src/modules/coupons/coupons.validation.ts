...
export const createCouponSchema = z.object({
  ...
  maxDiscountAmount: z.number().positive('Max discount amount must be positive').multipleOf(0.01).optional(),
  minOrderAmount: z.number().positive('Min order amount must be positive').multipleOf(0.01).optional(),
...
export const updateCouponSchema = z.object({
  ...
  maxDiscountAmount: z.number().positive('Max discount amount must be positive').multipleOf(0.01).optional().nullable(),
  minOrderAmount: z.number().positive('Min order amount must be positive').multipleOf(0.01).optional().nullable(),
