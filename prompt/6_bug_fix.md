...
reduce animation, when first time i load a section a animation is occur, but when the section is already loaded, i dont need an animation. i want a minimal and clean looks.  
